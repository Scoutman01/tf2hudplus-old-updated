"Resource/HudLayout.res"
{
    xHair
    {
        ...
        "xpos"          "c-101" // you will need to manually adjust these values per crosshair
        "ypos"          "c-96" // you will need to manually adjust these values per crosshair
        "wide"          "202" // you will need to manually adjust these values per crosshair
        "tall"          "198" // you will need to manually adjust these values per crosshair

        "font"          "xHair" // xHairOutline for crosshair outline
        "labelText"     "f" // see crosshairs.png for choices, uses tf2 crosshair by default
        "textAlignment" "center"

        "fgcolor" "255 255 255 192" // RGBA crosshair color
    }
    ...
    "Vignette"
    {
        ...
        "enabled"       "1"
        "image"         "../vgui/replay/thumbnails/vignette"
        "scaleImage"    "1"
    }
